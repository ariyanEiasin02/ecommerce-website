        ...
        <>
            <nav className="bg-white py-4 shadow-md">
                <div className="max-w-container mx-auto px-4 md:px-0">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-x-2">
                            <div className="hidden md:flex items-center">
                                <input
                                    className="border-2 border-gray-200 w-[200px] md:w-[300px] h-10 outline-none text-primary font-lato px-3"
                                    type="search"
                                    placeholder="Search"
                                />
                    ...
                    {menuShow && (
                        <ul className="flex flex-col items-center gap-y-4 mt-4 md:hidden font-lato text-base text-primary">
                            <li className="hover:text-secondCommon cursor-pointer">Home</li>
                            <li className="hover:text-secondCommon cursor-pointer">Pages</li>
                            <li className="hover:text-secondCommon cursor-pointer">Products</li>
                            <li className="hover:text-secondCommon cursor-pointer">Blog</li>
                            ...
                            <div className="flex items-center mt-2">
                                <input
                                    className="border-2 border-gray-200 w-[250px] h-10 outline-none text-primary font-lato px-3"
                                    type="search"
                                    placeholder="Search"
                                />
                                <button className="bg-secondCommon p-[10px]">
